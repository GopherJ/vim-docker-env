...
RUN curl -o- https://cdn.jsdelivr.net/gh/nvm-sh/nvm@v0.37.2/install.sh | bash \
    ...
    && npm install -g yarn ts-node @vue/cli create-react-app create-near-app vls typescript eslint eslint-plugin-vue prettier neovim truffle near-cli assemblyscript browserify @polkadot/api-cli @open-web3/parachain-launch
